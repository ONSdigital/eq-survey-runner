...
class TestHappyPath(IntegrationTestCase):
    ...
    def happy_path(self, form_type_id, eq_id):
        ...
        resp = self.client.post('/questionnaire/' + form_type_id + '/789/introduction', data=post_data, follow_redirects=False)
        ...
        self.assertRegexpMatches(resp.headers['Location'], r'\/questionnaire\/' + form_type_id + '\/789\/summary$')
