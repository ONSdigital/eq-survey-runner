...
class TestConfirmationPage(StarWarsTestCase):
    ...
    def test_confirmation_page(self):
        ...
        response = self.client.post('/questionnaire/0/rouge_one/201604/789/introduction', data=post_data, follow_redirects=False)
        ...
        self.complete_survey(confirmation_page, 'rouge_one')
