...
class TokenGenerator:
    ...
    def generate_token(self, payload):
        rrm_private_key = self.application.config['EQ_USER_AUTHENTICATION_RRM_PRIVATE_KEY']
        rrm_private_key_password = self.application.config['EQ_USER_AUTHENTICATION_RRM_PRIVATE_KEY_PASSWORD']
        sr_public_key = self.application.config['EQ_USER_AUTHENTICATION_SR_PUBLIC_KEY']
