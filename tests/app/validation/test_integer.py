...
class IntegerTest(unittest.TestCase):
    ...
    def test_integer_validator(self):
        ...
        self.assertEquals('\'None\' is not an integer', result.errors[0])
        ...
        self.assertFalse(result.is_valid)
        self.assertEquals(len(result.errors), 1)
        self.assertEquals('\'a\' is not an integer', result.errors[0])

        # decimal number
        result = integer.validate('1.3')
        self.assertFalse(result.is_valid)
        self.assertEquals(len(result.errors), 1)
        self.assertEquals('\'1.3\' is not an integer', result.errors[0])
