...
class TestRoutingEngine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.routing_engine = RoutingEngine(self.questionnaire)
        self.user_journey_manager = UserJourneyManager(self.questionnaire)
    ...
    def test_get_first_block(self):
        ...
        next_location =self.routing_engine.get_first_block()
        self.assertEqual('f22b1ba4-d15f-48b8-a1f3-db62b6f34cc0', next_location)
    ...
    def test_routing_with_rules_with_when(self):
        ...
        next_location = self.update_user_journey_manager(current_block, user_answers)
    ...
    def update_user_journey_manager(self, current_block, user_answers):

        self.user_journey_manager.go_to_state(current_block)
        self.user_journey_manager.update_state(current_block, user_answers)
