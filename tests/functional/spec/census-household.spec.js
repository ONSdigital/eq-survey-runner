  ...
  it('Given a census household survey, When one person in household, Then persons name should appear on member details pages.', function () {
    ...
    return helpers.startCensusQuestionnaire('census_household.json', false, 'GB-WLS')
      ...
      .then(() => {
        ...
        return browser
          .click(HouseholdMemberBegin.submit())
          .getText(HouseholdMemberBegin.displayedName()).should.eventually.contain(person)
          .click(DetailsCorrect.yesThisIsMyFullName())
          .click(DetailsCorrect.submit())
          .getText(DetailsCorrect.displayedName()).should.eventually.contain(person)
          .click(Over16.yes())
          .click(Over16.submit())
          .getText(Over16.displayedName()).should.eventually.contain(person)
          .click(PrivateResponse.noIDoNotWantToRequestAPersonalForm())
          .click(PrivateResponse.submit())
          .getText(PrivateResponse.displayedName()).should.eventually.contain(person)
          .click(Sex.male())
          .click(Sex.submit())
          .getText(Sex.displayedName()).should.eventually.contain(person)
          .setValue(DateOfBirth.day(), 2)
          .selectByValue(DateOfBirth.month(),4)
          .setValue(DateOfBirth.year(), 1980)
          .click(DateOfBirth.submit())
          .getText(DateOfBirth.displayedName()).should.eventually.contain(person)
          .click(MaritalStatus.married())
          .click(MaritalStatus.submit())
          .getText(MaritalStatus.displayedName()).should.eventually.contain(person)
          .click(AnotherAddress.no())
          .click(AnotherAddress.submit())
          .getText(AnotherAddress.displayedName()).should.eventually.contain(person)
          .click(InEducation.no())
          .click(InEducation.submit())
          .getText(InEducation.displayedName()).should.eventually.contain(person)
          .click(CountryOfBirth.walesWales())
          .click(CountryOfBirth.submit())
          .getText(CountryOfBirth.displayedName()).should.eventually.contain(person)
          .click(Carer.no())
          .click(Carer.submit())
          .getText(Carer.displayedName()).should.eventually.contain(person)
          .click(NationalIdentity.walesWelsh())
          .click(NationalIdentity.submit())
          .getText(NationalIdentity.displayedName()).should.eventually.contain(person)
          .click(EthnicGroup.walesBlackAfricanCaribbeanBlackBritish())
          .click(EthnicGroup.submit())
          .getText(EthnicGroup.displayedName()).should.eventually.contain(person)
          .click(BlackEthnicGroup.african())
          .click(BlackEthnicGroup.submit())
          .getText(WhiteEthnicGroup.displayedName()).should.eventually.contain(person)
          .click(UnderstandWelsh.noneOfTheAbove())
          .click(UnderstandWelsh.submit())
          .getText(Language.displayedName()).should.eventually.contain(person)
          .click(Language.welshEnglishOrWelsh())
          .click(Landlord.submit())
          .getText(Religion.displayedName()).should.eventually.contain(person)
          .click(Religion.welshNoReligion())
          .click(Religion.submit())
          .getText(PastUsualAddress.displayedName()).should.eventually.contain(person)
          .click(PastUsualAddress.thisAddress())
          .click(PastUsualAddress.submit())
          .getText(Passports.displayedName()).should.eventually.contain(person)
          .click(Passports.unitedKingdom())
          .click(Passports.submit())
          .getText(Disability.displayedName()).should.eventually.contain(person)
          .click(Disability.no())
          .click(Disability.submit())
          ...
          .click(EmploymentType.submit())
          .click(Jobseeker.yes())
          .click(Jobseeker.submit())
          .click(JobAvailability.yes())
          .click(JobAvailability.submit())
          .click(JobPending.no())
          .click(JobPending.submit())
          .click(Occupation.aStudent())
          .click(Occupation.submit())
          .click(EverWorked.yes())
