...
describe('Feature: Routing on a Number', function () {
  ...
  describe('Equals', function () {
    describe('Given I start number routing equals survey', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_equals.json').then(openBrowser => browser = openBrowser);
      });
  ...
  describe('Not Equals', function () {
    describe('Given I start number routing not equals survey', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_not_equals.json').then(openBrowser => browser = openBrowser);
      });
  ...
  describe('Greater Than', function () {
    describe('Given I start number routing greater then survey', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_greater_than.json').then(openBrowser => browser = openBrowser);
      });
  ...
  describe('Less Than', function () {
    describe('Given I start number routing less then survey', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_less_than.json').then(openBrowser => browser = openBrowser);
      });
  ...
  describe('Greater Than or Equal', function () {
    describe('Given I start number routing greater then or equal survey', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_greater_than_or_equal.json').then(openBrowser => browser = openBrowser);
      });
    ...
    describe('Given I have number routing with a greater than or equal to single condition', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_greater_than_or_equal_single_condition.json').then(openBrowser => browser = openBrowser);
      });
  ...
  describe('Less Than or Equal', function () {
    describe('Given I start number routing less then or equal survey', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_less_than_or_equal.json').then(openBrowser => browser = openBrowser);
      });
    ...
    describe('Given I have number routing with a less than or equal to single condition', function () {
      before(function () {
        browser = helpers.openQuestionnaire('test_routing_number_less_than_or_equal_single_condition.json').then(openBrowser => browser = openBrowser);
      });
