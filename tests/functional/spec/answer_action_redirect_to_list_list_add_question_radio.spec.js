...
const AnyoneLiveAtListCollector = require('../generated_pages/answer_action_redirect_to_list_add_question_radio/anyone-else-live-at.page');
const AnyoneLiveAtListCollectorAddPage = require('../generated_pages/answer_action_redirect_to_list_add_question_radio/anyone-else-live-at-add.page');
const AnyoneLiveAtListCollectorRemovePage = require('../generated_pages/answer_action_redirect_to_list_add_question_radio/anyone-else-live-at-remove.page');
const AnyoneUsuallyLiveAt = require('../generated_pages/answer_action_redirect_to_list_add_question_radio/anyone-usually-live-at.page');
...
describe('Answer Action: Redirect To List Add Question (Radio)', function () {
  ...
  describe('Given the user is on a question with a "RedirectToListAddQuestion" action enabled', function () {
    ...
    before('Launch survey', function () {
      return helpers.openQuestionnaire('test_answer_action_redirect_to_list_add_question_radio.json');
    });
