...
describe('UKIS - Did you invest in design?', function() {
  ...
  it('Given I am answering question 3.13 under 3. Innovation Investment block, When I  select Yes as the response, Then I am routed to question 3.14', function() {
    ...
    expect(ExpenditureDesign2016.isOpen()).to.equal(true, 'Expected to Navigate to Q: 3.14')
  })
  ...
  it('Given I am answering question 3.13 under 3. Innovation Investment block, When I  select No as the response, Then I am routed to question 3.15', function() {
    ...
    InvestmentTrainingInnovative.clickInvestmentTrainingInnovativeAnswerYes().submit()
    ExpenditureTrainingInnovative2016.setExpenditureTrainingInnovative2016Answer(1234).submit()
    InvestmentDesignFutureInnovation.clickInvestmentDesignFutureInnovationAnswerNo().submit()
    expect(InvestmentIntroductionInnovations.isOpen()).to.equal(true, 'Expected to Navigate to Q: 3.15')
  })
