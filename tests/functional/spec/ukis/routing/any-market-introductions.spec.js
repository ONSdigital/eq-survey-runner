  ...
  describe('UKIS - Any market Introductions?', function() {
    ...
    it('Given I am answering question 3.15 under 3. Innovation Investment block, When I  select Yes as the response, Then I am routed to question 3.16', function() {
      ...
      ExpenditureTrainingInnovative2016.setExpenditureTrainingInnovative2016Answer(1234).submit()
      InvestmentDesignFutureInnovation.clickInvestmentDesignFutureInnovationAnswerYes().submit()
      ExpenditureDesign2016.setExpenditureDesign2016Answer(54321).submit()
      InvestmentIntroductionInnovations.clickInvestmentIntroductionInnovationsAnswerYes().submit()
      expect(InvestmentPurposesInnovation2.isOpen()).to.equal(true, 'Expected to Navigate to Q: 3.16')
    ...
    it('Given I am answering question 3.15 under 3. Innovation Investment block, When I  select No as the response, Then I am routed to the interstital page that comes after 3.17, before Goods & Services questions ', function() {
      ...
      InvestmentDesignFutureInnovation.clickInvestmentDesignFutureInnovationAnswerYes().submit()
      ExpenditureDesign2016.setExpenditureDesign2016Answer(54321).submit()
      InvestmentIntroductionInnovations.clickInvestmentIntroductionInnovationsAnswerNo().submit()

      expect(InnovationInvestmentCompleted.isOpen()).to.equal(true, 'Expected to Navigate to the interstital page that comes after 3.17, before Goods & Services questions')
    })
    ...
    it('Given I am answering question 3.15 under 3. Innovation Investment block, When no response is selected, Then I am routed to the interstital page that comes after 3.17, before Goods & Services questions', function() {
      ...
      InvestmentDesignFutureInnovation.clickInvestmentDesignFutureInnovationAnswerYes().submit()
      ExpenditureDesign2016.setExpenditureDesign2016Answer(54321).submit()
      InvestmentIntroductionInnovations.submit()
