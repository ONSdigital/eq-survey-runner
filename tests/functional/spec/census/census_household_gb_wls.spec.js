...
const NO_OF_HOUSEHOLDERS = 1;
const NO_OF_HOUSEHOLDER_TEMP_AWAY = 0;
const NO_OF_VISITORS = 2; // Default 1

const TOTAL_HOUSEHOLDERS = HAS_PRIMARY + NO_OF_HOUSEHOLDERS + NO_OF_HOUSEHOLDER_TEMP_AWAY;


const addPeople = (noOfPeople, listCollectorScreen, listCollectorAddScreen, firstName = 'Person', isVisitor = false, addOption = listCollectorScreen.anyoneElseYesINeedToAddSomeone) => {
...
describe('@watch Census Household: GB-WLS', () => {
  ...
  it(`Add ${NO_OF_HOUSEHOLDERS} Household Member(s)`, () => addPeople(NO_OF_HOUSEHOLDERS, AnyoneElseListCollector, AnyoneElseListCollectorAdd)
    ...
    .click(AnyoneElseListCollector.anyoneElseNoNoOneUsuallyLivesHere())
    .click(AnyoneElseListCollector.submit())
  );

  it(`Add ${NO_OF_HOUSEHOLDER_TEMP_AWAY} Temporarily Away Household Member(s)`, () => addPeople(NO_OF_HOUSEHOLDER_TEMP_AWAY, AnyoneElseTempAwayListCollector, AnyoneElseTempAwayListCollectorAdd, 'Person Temp Away', false, AnyoneElseTempAwayListCollector.yesINeedToAddSomeone)
  ...
  it(`Add ${NO_OF_VISITORS} Visitor(s)`, () => browser
    ...
    .then(() => addPeople(NO_OF_VISITORS - 1, VisitorListCollector, VisitorListCollectorAdd, 'Visitor', true, VisitorListCollector.yesINeedToAddSomeone)
