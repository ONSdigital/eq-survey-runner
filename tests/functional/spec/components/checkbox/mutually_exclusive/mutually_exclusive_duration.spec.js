...
const DurationPage = require('../../../../pages/components/checkbox/mutually-exclusive/mutually-exclusive-duration.page');
const SummaryPage = require('../../../../pages/components/checkbox/mutually-exclusive/optional-duration-section-summary.page');
...
describe('Component: Mutually Exclusive Duration With Single Checkbox Override', function() {
  ...
  beforeEach(function() {
    return helpers.openQuestionnaire('test_mutually_exclusive.json').then(() => {
          return browser.click(helpers.navigationLink('Duration'));
        });
  });
