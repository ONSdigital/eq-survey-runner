...
const YearDatePage = require('../../../../pages/components/checkbox/mutually-exclusive/mutually-exclusive-year-date.page');
const SummaryPage = require('../../../../pages/components/checkbox/mutually-exclusive/optional-year-section-summary.page');
...
describe('Component: Mutually Exclusive Year Date With Single Checkbox Override', function() {
  ...
  beforeEach(function() {
    return helpers.openQuestionnaire('test_mutually_exclusive.json').then(() => {
          return browser.click(helpers.navigationLink('Year Date'));
        });
  });
