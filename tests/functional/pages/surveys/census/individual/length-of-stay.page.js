...
class LengthOfStayPage extends QuestionPage {
  ...
  lessThan6MonthsLabel() { return '#label-length-of-stay-answer-0'; }

  answer6MonthsOrMoreButLessThan12Months() {
    return '#length-of-stay-answer-1';
  }

  answer6MonthsOrMoreButLessThan12MonthsLabel() { return '#label-length-of-stay-answer-1'; }

  answer12MonthsOrMore() {
    return '#length-of-stay-answer-2';
  }

  answer12MonthsOrMoreLabel() { return '#label-length-of-stay-answer-2'; }
