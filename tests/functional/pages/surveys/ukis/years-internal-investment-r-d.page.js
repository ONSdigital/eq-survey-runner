...
class YearsInternalInvestmentRDPage extends MultipleChoiceWithOtherPage {

  constructor() {
    super('years-internal-investment-r-d')
  }
...
export default new YearsInternalInvestmentRDPage()
