...
class BusinessChangesPage extends MultipleChoiceWithOtherPage {
  ...
  clickBusinessChangesBusinessPracticesAnswerNo() {
    browser.element('[id="business-changes-business-practices-answer-2"]').click()
    return this
  }
  ...
  clickBusinessChangesOrganisingAnswerNo() {
    browser.element('[id="business-changes-organising-answer-2"]').click()
    return this
  }
  ...
  clickBusinessChangesExternalRelationshipsAnswerNo() {
    browser.element('[id="business-changes-external-relationships-answer-2"]').click()
    return this
  }
  ...
  clickBusinessChangesAnswerNo() {
    browser.element('[id="business-changes-answer-2"]').click()
    return this
  }
