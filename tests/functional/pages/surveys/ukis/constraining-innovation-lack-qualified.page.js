...
class ConstrainingInnovationLackQualifiedPage extends MultipleChoiceWithOtherPage {

  constructor() {
    super('constraining-innovation-lack-qualified')
  }
...
export default new ConstrainingInnovationLackQualifiedPage()
