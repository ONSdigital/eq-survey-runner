...
class SignificantEventsPage extends MultipleChoiceWithOtherPage {
  ...
  clickSignificantEventsEstablishedAnswerNo() {
    browser.element('[id="significant-events-established-answer-2"]').click()
    return this
  }
  ...
  clickSignificantEventsTurnoverIncreaseAnswerNo() {
    browser.element('[id="significant-events-turnover-increase-answer-2"]').click()
    return this
  }
  ...
  clickSignificantEventsTurnoverDecreaseAnswerNo() {
    browser.element('[id="significant-events-turnover-decrease-answer-2"]').click()
    return this
  }
