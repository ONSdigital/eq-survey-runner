...
class KindFinancialCentralGovernmentSupportPage extends MultipleChoiceWithOtherPage {

  constructor() {
    super('kind-financial-central-government-support')
  }
...
export default new KindFinancialCentralGovernmentSupportPage()
