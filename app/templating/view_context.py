...
def build_view_context_for_list_collector(
    rendered_block, list_store, answer_store, form
):
...
def build_view_context_for_non_question(rendered_block, metadata):
    return {'block': rendered_block, 'metadata': dict(metadata)}


def build_view_context_for_question(
    rendered_block, form
):  # noqa: C901, E501  pylint: disable=too-complex,line-too-long,too-many-locals,too-many-branches
