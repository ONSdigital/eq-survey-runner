from quart import Blueprint, current_app, session as cookie_session, render_template
...
def contact():
    ...
    contact_template = render_template('static/contact-us.html',
                                       session=session,
                                       survey_id=survey_id,
...
def legal():
    cookie_template = render_template('static/cookies-privacy.html',
                                      analytics_ua_id=current_app.config['EQ_UA_ID'])
