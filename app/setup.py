...
def add_blueprints(application):
    ...
    from app.views.download_submission import download_submission_blueprint
    application.register_blueprint(download_submission_blueprint)
    download_submission_blueprint.config = application.config.copy()
