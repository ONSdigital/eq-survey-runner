...
EQ_SUBMITTED_RESPONSES_TABLE_NAME = os.getenv('EQ_SUBMITTED_RESPONSES_TABLE_NAME')
EQ_QUESTIONNAIRE_STATE_TABLE_NAME = os.getenv('EQ_QUESTIONNAIRE_STATE_TABLE_NAME')
...
EQ_SESSION_TABLE_NAME = os.getenv('EQ_SESSION_TABLE_NAME')
EQ_SESSION_DYNAMO_READ = parse_mode(os.getenv('EQ_SESSION_DYNAMO_READ', 'False'))
EQ_SESSION_DYNAMO_WRITE = parse_mode(os.getenv('EQ_SESSION_DYNAMO_WRITE', 'False'))
EQ_USED_JTI_CLAIM_TABLE_NAME = os.getenv('EQ_USED_JTI_CLAIM_TABLE_NAME')
