...
def get_questionnaire(schema, questionnaire_store):
    ...
    hub_required_sections = are_hub_required_sections_complete(questionnaire_store, schema)

    if not schema.is_hub_enabled() or not hub_required_sections:
...
def _render_page(
    ...
    required_sections_complete = are_hub_required_sections_complete(questionnaire_store, schema)

    display_return_to_hub_link = get_return_to_hub_link(schema, block_type, required_sections_complete)
